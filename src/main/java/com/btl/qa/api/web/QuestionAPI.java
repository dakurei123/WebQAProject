...
public class QuestionAPI {
	...
	public List<QuestionDTO> getQuestionByUser(@PathVariable Long id){
		return questionService.getQuestionsByUser(id);
	}
	
	@GetMapping("/api/user/question/category")
	public List<QuestionDTO> getQuestionsByUserAndCategory(@RequestParam Long userId, @RequestParam Long categoryId){
		return questionService.getQuestionByUserAndCategory(userId, categoryId);
	}
	
	@GetMapping("/api/user/question/search/")
	public List<QuestionDTO> searchQuestionUser(@RequestParam Long userId, @RequestParam String key){
	...
	public List<QuestionDTO> getQuestionByCategory(@PathVariable Long id){
		return questionService.getQuestionsByCategory(id);
	}
	
	@GetMapping("/api/question/search")
	public List<QuestionDTO> SearchQuestion(@RequestParam String key){
